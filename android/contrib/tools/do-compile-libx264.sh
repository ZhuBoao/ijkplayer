...
FF_CFG_FLAGS="$FF_CFG_FLAGS --libdir=${FF_PREFIX}/lib"
FF_CFG_FLAGS="$FF_CFG_FLAGS --includedir=${FF_PREFIX}/include"
FF_CFG_FLAGS="$FF_CFG_FLAGS --bindir=${FF_PREFIX}/bin"
